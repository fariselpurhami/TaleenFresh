...
// عنصر الـ Pulse الأساسي (بدون حواف دائرية عشان نقدر نتحكم فيها من بره)
      ...
      <div className="px-6 mb-8">
        ...
        <div className="grid grid-cols-2 gap-4">
          {Array.from({ length: CONFIG.SKELETON_ITEMS_COUNT }).map((_, index) => (
            // هذا الكارت مطابق في الارتفاع والأبعاد لـ ProductCard الحقيقي
            <div 
              key={index}
